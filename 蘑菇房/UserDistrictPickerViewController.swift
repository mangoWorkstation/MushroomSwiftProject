...
//    var dic : Dictionary<String,[String]> = ["北京市":["北京市"],
//                                           "上海市":["上海市"],
//                                           "天津市":["天津市"],
//                                           "重庆市":["重庆市"],
...
//    let provinces = ["北京市","上海市","天津市","重庆市","河北省","山西省","陕西省","山东省","河南省","辽宁省","吉林省","黑龙江省","江苏省","浙江省","安徽省","江西省","福建省","湖北省","湖南省","四川省","贵州省","云南省","广东省","海南省","甘肃省","青海省","台湾省","内蒙古自治区","新疆维吾尔自治区","西藏自治区","广西壮族自治区","宁夏回族自治区"]
    ...
    var currentProvince:String! = "北京市"
